...
{pico} is a toy package that generates [the absolute bare-bones skeleton of an R package](http://kbroman.org/pkg_primer/pages/minimal.html). It may be a useful teaching aid to demystify the perceived complexity of R packages, or a quick-start to create a package of your often-used personal functions. Read more in [the accompanying blog post](https://www.rostrum.blog/2021/04/18/pico-pkg/).
...
* [Karl Broman’s _R Package Primer_ site](https://kbroman.org/pkg_primer/)
...
1. Re-run `install_local()` as above, but with `force = TRUE` to overwrite the old version
1. Restart R
